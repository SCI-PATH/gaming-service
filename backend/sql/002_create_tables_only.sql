-- Tables only for engagement_gaming (schema already exists)
-- In DBeaver: select neondb connection, then Alt+X (Execute SQL Script)
...
CREATE TABLE IF NOT EXISTS engagement_gaming.level_progress (
  ...
  mastery_score         NUMERIC(6,4),                     -- 0â€“1
...
-- ---------------------------------------------------------------------------
-- 5) Quiz attempts (science items consumed from question_engine â€” soft ref)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 8) Frustration scores (time-series â€” research critical)
-- ---------------------------------------------------------------------------
