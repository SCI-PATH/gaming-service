...
export function evaluateStudentState(metrics = {}, opts = {}) {
  ...
  // --- Hard open: 4+ wrong answers total OR 4+ on same concept ---
  if (flags.same_concept_x4 || flags.total_incorrect_x4) {
    ...
    return {
      ...
      // Comprehensive map of every incorrect answer (all concepts they struggled with)
  ...
  if (
    ...
    return {
      ...
      indicators: supportIndicators,
      offerMindMap: conceptMisses >= 2 || incorrect >= 3,
    };
  }
