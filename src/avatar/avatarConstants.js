...
export const AVATAR_THRESHOLDS = {
  ...
  conceptMissesForMindMap: 4,

  /**
   * Total incorrect answers (any topics) before mentor auto-opens.
   * Farm questions often change topic each prompt — total count is the
   * reliable signal for “four wrong answers.”
   */
  totalIncorrectForSupport: 4,
