...
export function normalizeAssessmentMiss(source = {}) {
  ...
  return {
    ...
    chapter,
    chapter_id: compactText(source.chapter_id || q.chapter_id || q.chapterId || ''),
    topic_id: compactText(source.topic_id || q.topic_id || q.topicId || ''),
    grade: source.grade || q.grade || null,
