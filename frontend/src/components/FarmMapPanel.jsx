...
import { FARM_SHOP_ZONE, PLANT_PLOTS } from '../data/plantPlots.js';
...
/**
 * Farm map: plant beds (gold), farm shop, unlock landmarks, live YOU pin.
 */
      ...
      >
        <div className="farm-map-grid">
          ...
          <div
            ...
            title="Farm Shop — press E to unload"
          >
            <span>SHOP</span>
          </div>
